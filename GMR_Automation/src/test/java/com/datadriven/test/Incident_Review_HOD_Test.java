...
public class Incident_Review_HOD_Test {
	WebDriver driver;
	...
	public void Incident_Review_HOD(String Username,String Password,String Function,String Agency,String SubLocation,String Shift,String ExactLocation,String Descriptionofwhathappened,
	...
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys(HODUsername);
		Thread.sleep(1000);
		//Enter Password
		driver.findElement(By.id("txtPassword")).sendKeys(HODPassword);
		Thread.sleep(1000);
		//Click on submit
