...
public class Incident_Invstegation_Review_PlantEHSHead_Test {
	...
	public void Incident_Invstegation_Review_PlantEHSHead(String Username,String Password,String Function,String Agency,String SubLocation,String Shift,String ExactLocation,String Descriptionofwhathappened,
	...
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys(PlantEHSHUsername);
		Thread.sleep(1000);
		//Enter Password
		driver.findElement(By.id("txtPassword")).sendKeys(PlantEHSHPassword);
		Thread.sleep(8000);
		//Click on submit
		...
		Authorizationaction.selectByVisibleText(AuthorizationActionPlantEHSH);
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys(CommentPlantEHSH);
		Thread.sleep(1000);
