...
public class NearMiss_Invstegation_Review_Plant_HEAD_Test {
	WebDriver driver;
	...
	public void NearMiss_Invstegation_Review_Plant_HEAD(String UserName,String Password,String Function,String Agency,String SubLocation,String ExactLocation,String Severity,String Descriptionofwhathappened,String ImmediateContainmentAction,
	...
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys(PlantHEADUsername);
		Thread.sleep(1000);
		//Enter Password
		...
		Authorizationaction.selectByVisibleText(PlantHEADAuthorizationaction);
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys(PlantHEADComment);
		Thread.sleep(1000);
