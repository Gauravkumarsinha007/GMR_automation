...
public class NearMiss_Invstegation_Review_O_M_Head_Test {
	WebDriver driver;
	...
	public void NearMiss_Invstegation_Review_O_M_Head(String UserName,String Password,String Function,String Agency,String SubLocation,String ExactLocation,String Severity,String Descriptionofwhathappened,String ImmediateContainmentAction,
	...
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys(ReviewOMHeadUsername);
		Thread.sleep(1000);
		//Enter Password
		driver.findElement(By.id("txtPassword")).sendKeys(ReviewOMHeadPassword);
		Thread.sleep(1000);
		//Click on submit
		...
		Authorizationaction.selectByVisibleText(ReviewOMHeadAuthorizationAction);
		Thread.sleep(5000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys(ReviewOMHeadComment);
		Thread.sleep(3000);
