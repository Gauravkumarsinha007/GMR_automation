...
public class Meeting_Completed_Test {
	...
	public void Meeting_Completed(String UserName,String Password,String url,String MeetingType,String Function,String MeetingTopic,String DurationHH,String DurationMM,
			...
			String Comment,String AuthorizationactionPostpone,String Postponecomment,String Authorizationactioncancelled,String cancelledcomment) throws InterruptedException, AWTException
	{
		...
		Authorizationaction.selectByVisibleText(AuthorizationactionCompleted);
		Thread.sleep(2000);
